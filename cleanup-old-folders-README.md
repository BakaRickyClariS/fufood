...
- [ ] **已完成 import 路徑更新**
  - 所有 `@/data/*` 已改為 `@/modules/*` 或 `@/shared/*`
  - 所有 `@/components/ui/*` 已改為 `@/shared/components/ui/*`
  - 所有 `@/api/*` 已改為 `@/modules/*/services/*`
...
// InventorySection
from '@/components/layout/InventorySection' → '@/modules/inventory/components/InventorySection'

// RecipeSection
from '@/components/layout/RecipeSection' → '@/modules/recipe/components/RecipeSection'

// MemberList
from '@/components/layout/MemberList' → '@/shared/components/layout/MemberList'

// inventory 子資料夾元件
from '@/components/layout/inventory/*' → '@/modules/inventory/components/*'
```
