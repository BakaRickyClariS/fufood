  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-white sticky top-0 z-20">
        ...
        <h1 className="text-lg font-bold text-neutral-900">{category.title.split(' ')[0]}</h1>
      ...
      <div className="px-4 mt-2 space-y-4">
        ...
        <div className="relative">
          ...
          <Button variant="ghost" size="icon" className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8">
             ...
             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 3H14M4.66667 8H11.3333M7.33333 13H8.66667" stroke="#171717" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
             </svg>
          </Button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
           {/* Mock Items */}
           {[1, 2, 3, 4].map((i) => (
             <div key={i} className="bg-white rounded-2xl p-3 shadow-sm aspect-[3/4] flex flex-col relative overflow-hidden">
