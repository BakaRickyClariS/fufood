  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="p-4 space-y-6">
        {/* 建立時間 (Display Only) */}
        <div>
          <label className="block text-xs font-medium text-neutral-500 mb-1">建立時間</label>
        ...
        {/* 清單名稱 */}
        <div>
           <label className="block text-sm font-bold text-neutral-800 mb-2">清單名稱</label>
           <input
             type="text"
             value={name}
        ...
        {/* 預計採買日期 */}
        <div>
           <label className="block text-sm font-bold text-neutral-800 mb-2">預計採買日期</label>
           <input
             type="date"
             value={scheduledDate}
        ...
        <div className="flex items-center justify-between py-2">
          ...
          >
            <div className={`w-4 h-4 rounded-full bg-white shadow-sm transition-transform ${notifyEnabled ? 'translate-x-6' : 'translate-x-0'}`} />
          </button>
        </div>

        {/* 封面照片選擇 */}
        <div>
          <label className="block text-sm font-bold text-neutral-800 mb-2">封面照片</label>
