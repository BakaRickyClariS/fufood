...
const FAQS: FAQItem[] = [
  {
    question: '如何掃描發票存入食材？',
    answer: '點擊底部導覽列的相機按鈕，選擇「掃描發票」，對準發票 QR Code 即可自動辨識並匯入食材。',
  },
  {
    question: '食材快過期會有提醒嗎？',
    answer: '有的，系統預設會在食材過期前 3 天發送推播通知。您可以在「設定 > 推播通知」中調整提醒設定。',
  },
  {
    question: '如何邀請家人共用冰箱？',
    answer: '請至首頁左上角切換群組，選擇「建立群組」或是在現有群組中點擊「邀請成員」，將邀請連結傳送給家人即可。',
  },
  {
    question: 'AI 食譜生成的次數有限制嗎？',
    answer: '免費版每日可生成 3 次食譜。升級至進階版後，即可享有無限次數生成的服務。',
  },
];
    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="max-w-layout-container mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm text-center">
          ...
          <h3 className="text-lg font-bold text-neutral-800 mb-1">遇到問題了嗎？</h3>
          <p className="text-sm text-neutral-500 mb-4">我們的客服團隊隨時為您服務</p>
        ...
        {/* FAQ List */}
        <div>
          <h3 className="text-lg font-bold text-neutral-800 mb-4 px-2">常見問題</h3>
              ...
              >
                ...
                <div 
                  className={`px-5 text-sm text-neutral-600 leading-relaxed bg-neutral-50 overflow-hidden transition-all duration-300 ease-in-out ${
                    openIndex === index ? 'max-h-40 py-4 border-t border-neutral-100' : 'max-h-0'
                  }`}
                >
                  {faq.answer}
                </div>
