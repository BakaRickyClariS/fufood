...
const ReportProblem = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <form onSubmit={handleSubmit} className="max-w-layout-container mx-auto px-4 py-6 space-y-6">
        
        <div className="space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-bold text-neutral-800">問題類型</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-neutral-800">問題描述</label>
            <textarea
              required
              rows={5}
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-neutral-800">上傳截圖 (選填)</label>
        ...
        <div className="pt-4">
          ...
          <p className="text-xs text-center text-neutral-400 mt-4 px-4">
            系統將會同時傳送您的裝置資訊與 App 版本 (v1.1.0) 以協助工程師排查問題。
          </p>
        </div>
