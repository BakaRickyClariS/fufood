...
export const SharedListDetail = ({ listId }: SharedListDetailProps) => {
  ...
  const statusConfig = {
    ...
    'pending-purchase': { text: '待採買', className: 'bg-yellow-400/80 text-white' },
    ...
    <div className="min-h-screen bg-neutral-50 pb-24">
      ...
      <div className="relative h-48 bg-white">
        ...
        <div className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between">
          ...
          <div className={`px-3 py-1 rounded-full text-xs font-bold backdrop-blur ${currentStatus.className}`}>
            {currentStatus.text}
          </div>
        </div>
